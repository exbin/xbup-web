...
showNavigation();
?>
<h1 id="concept">Concept: Block Transformation</h1>
...
<h2 class="sectionedit2" id="transformation">Transformation</h2>
<div class="level2">
...
<ul>
<li class="level1"><div class="li"> Generalization / Specialization - For blocks which have fixed attribute or subblock compare to it&#039;s parent (for example UTF-String → String).</div>
</li>
<li class="level1"><div class="li"> Parametric types - It is also possible to use ancestor type (for example List of pictures → List).</div>
</li>
</ul>
...
<ul>
<li class="level1"><div class="li"> Getting a list of blocks to which can be transformed - For given block there should be defined way to determine the blocks, to which can it be algorithmically converted to and that both for when it is maintained all the information, and also even if part of it is lost.</div>
</li>
...
<li class="level1"><div class="li"> Transformation chaining - It is possible to perform multiple transformations in a row as a sequence, also to determine the sequence (the use of lattices?).</div>
</li>
...
<h3 class="sectionedit3" id="default_transformation">Default Transformation</h3>
<div class="level3">
...
<ul>
<li class="level1"><div class="li"> The transformation of older versions of a document to later one, and vice versa</div>
</li>
...
<li class="level1"><div class="li"> Blocks with fixed attributes</div>
</li>
<li class="level1"><div class="li"> Child to parent transformation</div>
</li>
</ul>
...
<h3 class="sectionedit4" id="transformation_graph">Transformation Graph</h3>
<div class="level3">
...
<h3 class="sectionedit5" id="limitation_rules">Limitation Rules</h3>
<div class="level3">
...
<h2 class="sectionedit6" id="transformation_function">Transformation Function</h2>
<div class="level2">
...
<h3 class="sectionedit7" id="data_transformations">Data Transformations</h3>
<div class="level3">
...
<h3 class="sectionedit8" id="extraction_blocks">Extraction Blocks</h3>
<div class="level3">
...
<h3 class="sectionedit9" id="validation_blocks">Validation Blocks</h3>
<div class="level3">
...
<h3 class="sectionedit10" id="conversion_blocks">Conversion Blocks</h3>
<div class="level3">
...
<h3 class="sectionedit11" id="document_analysability">Document Analysability</h3>
<div class="level3">
...
<ul>
<li class="level1"><div class="li"> Define the type of items including, for example, UBPointer on the next level + relevant types linked subblocks<br/>
</div>
</li>
<li class="level1"><div class="li"> “system blocks” to rename on something more intelligent<br/>
</div>
</li>
<li class="level1"><div class="li"> Argumentation for the order of the system blocks <br/>
</div>
</li>
<li class="level1"><div class="li"> Argumentation for attribute order<br/>
</div>
</li>
</ul>
