...
<p>
Storage formats for storing audio data. It is actually a block for application for wave contour, which is given in physical units. It should be noted that this is mainly a case of PCM modulation … As in the case of bitmaps, also here will be strong inspiration with already existing solutions (such as Microsoft WAV).
</p>
